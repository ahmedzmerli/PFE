...
export class BlacklistService {
  ...
  create(data: any) {
    return this.http.post('http://localhost:8081/api/v1/blacklist', data);
  }

  whitelist(data: any): Observable<any> {
    return this.http.post('http://localhost:8081/api/v1/blacklist/whitelist', data);
  }
